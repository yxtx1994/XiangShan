  ...
  with HasPerfEvents
{
  ...
  val release2Cycle = utils.HackedAPI.HackedRegEnable(io.release, io.release.valid)
  val release2Cycle_dup_lsu = utils.HackedAPI.HackedRegEnable(io.release, io.release.valid)
